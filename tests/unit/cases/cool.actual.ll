...
dispatch.ok:                                      ; preds = %entry
  ...
  %Object.newtmp = call ptr @Object.new()
  %dispatch.isnull3 = icmp eq ptr %Object.newtmp, null
...
dispatch.ok1:                                     ; preds = %dispatch.ok
  %vtable.ptr4 = load ptr, ptr %Object.newtmp, align 8
  %method.ptr.addr5 = getelementptr ptr, ptr %vtable.ptr4, i64 4
  %method.ptr6 = load ptr, ptr %method.ptr.addr5, align 8
  %dispatch.result = call ptr %method.ptr6(ptr %Object.newtmp)
  %dispatch.isnull9 = icmp eq ptr %dispatch.result, null
...
dispatch.ok7:                                     ; preds = %dispatch.ok1
  %dispatch.result10 = call ptr @String_substr(ptr %dispatch.result, i32 4, i32 1)
  %dispatch.result11 = call ptr %method.ptr(ptr %self, ptr %dispatch.result10)
  %dispatch.isnull14 = icmp eq ptr %dispatch.result11, null
...
dispatch.ok12:                                    ; preds = %dispatch.ok7
  %vtable.ptr15 = load ptr, ptr %dispatch.result11, align 8
  ...
  %isvoidtmp = icmp eq ptr %self18, null
  %dispatch.result19 = call ptr @String_substr(ptr @.str.const.17434171918012309744, i32 1, i32 3)
  %dispatch.result20 = call ptr %method.ptr17(ptr %dispatch.result11, ptr %dispatch.result19)
...
dispatch.abort13:                                 ; preds = %dispatch.ok7
  call void @abort()
  unreachable

dispatch.ok22:                                    ; preds = %dispatch.ok12
  ...
  %dispatch.result28 = call ptr %method.ptr27(ptr %self21, ptr @.str.18400681194753865968)
  ret ptr %dispatch.result28

dispatch.abort23:                                 ; preds = %dispatch.ok12
  call void @abort()
  unreachable
}
