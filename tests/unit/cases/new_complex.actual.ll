...
@_ZTV7Complex = linkonce_odr constant [17 x ptr] [ptr null, ptr @_ZTI7Complex, ptr @Object_copy, ptr @Object_abort, ptr @Object_type_name, ptr @IO_out_string, ptr @IO_out_int, ptr @IO_in_string, ptr @IO_in_int, ptr @Complex.init, ptr @Complex.print, ptr @Complex.reflect_0, ptr @Complex.reflect_X, ptr @Complex.reflect_Y, ptr @Complex.equal, ptr @Complex.x_value, ptr @Complex.y_value], align 8
...
dispatch.ok2:                                     ; preds = %dispatch.ok
  ...
  %dispatch.isnull12 = icmp eq ptr %c9, null
...
dispatch.ok10:                                    ; preds = %dispatch.ok2
  %vtable.ptr13 = load ptr, ptr %c9, align 8
  %method.ptr.addr14 = getelementptr ptr, ptr %vtable.ptr13, i64 11
  %method.ptr15 = load ptr, ptr %method.ptr.addr14, align 8
  %dispatch.result16 = call ptr %method.ptr15(ptr %c9)
  %eqtmp = icmp eq ptr %dispatch.result8, %dispatch.result16
...
then:                                             ; preds = %dispatch.ok10
  %self = load ptr, ptr %this.addr, align 8
  %dispatch.isnull19 = icmp eq ptr %self, null
  br i1 %dispatch.isnull19, label %dispatch.abort18, label %dispatch.ok17

dispatch.ok17:                                    ; preds = %then
  %vtable.ptr20 = load ptr, ptr %self, align 8
  %method.ptr.addr21 = getelementptr ptr, ptr %vtable.ptr20, i64 5
  %method.ptr22 = load ptr, ptr %method.ptr.addr21, align 8
  %dispatch.result23 = call ptr %method.ptr22(ptr %self, ptr @.str.18088364639186711304)
  br label %ifcont

dispatch.abort18:                                 ; preds = %then
  call void @abort()
  unreachable

else:                                             ; preds = %dispatch.ok10
...
dispatch.ok25:                                    ; preds = %else
  ...
  %dispatch.result31 = call ptr %method.ptr30(ptr %self24, ptr @.str.15701132810540416685)
  br label %ifcont

dispatch.abort26:                                 ; preds = %else
  call void @abort()
  unreachable

ifcont:                                           ; preds = %dispatch.ok25, %dispatch.ok17
  %cond_result = phi ptr [ %dispatch.result23, %dispatch.ok17 ], [ %dispatch.result31, %dispatch.ok25 ]
  %c32 = load ptr, ptr %c, align 8
  %dispatch.isnull35 = icmp eq ptr %c32, null
  br i1 %dispatch.isnull35, label %dispatch.abort34, label %dispatch.ok33

dispatch.ok33:                                    ; preds = %ifcont
  %vtable.ptr36 = load ptr, ptr %c32, align 8
  %method.ptr.addr37 = getelementptr ptr, ptr %vtable.ptr36, i64 12
  %method.ptr38 = load ptr, ptr %method.ptr.addr37, align 8
  %dispatch.result39 = call ptr %method.ptr38(ptr %c32)
  %dispatch.isnull42 = icmp eq ptr %dispatch.result39, null
  br i1 %dispatch.isnull42, label %dispatch.abort41, label %dispatch.ok40

dispatch.abort34:                                 ; preds = %ifcont
  call void @abort()
  unreachable

dispatch.ok40:                                    ; preds = %dispatch.ok33
  %vtable.ptr43 = load ptr, ptr %dispatch.result39, align 8
  %method.ptr.addr44 = getelementptr ptr, ptr %vtable.ptr43, i64 13
  %method.ptr45 = load ptr, ptr %method.ptr.addr44, align 8
  %dispatch.result46 = call ptr %method.ptr45(ptr %dispatch.result39)
  %dispatch.isnull49 = icmp eq ptr %dispatch.result46, null
  br i1 %dispatch.isnull49, label %dispatch.abort48, label %dispatch.ok47

dispatch.abort41:                                 ; preds = %dispatch.ok33
  call void @abort()
  unreachable

dispatch.ok47:                                    ; preds = %dispatch.ok40
  %vtable.ptr50 = load ptr, ptr %dispatch.result46, align 8
  %method.ptr.addr51 = getelementptr ptr, ptr %vtable.ptr50, i64 14
  %method.ptr52 = load ptr, ptr %method.ptr.addr51, align 8
  %c53 = load ptr, ptr %c, align 8
  %dispatch.isnull56 = icmp eq ptr %c53, null
  br i1 %dispatch.isnull56, label %dispatch.abort55, label %dispatch.ok54

dispatch.abort48:                                 ; preds = %dispatch.ok40
  call void @abort()
  unreachable

dispatch.ok54:                                    ; preds = %dispatch.ok47
  %vtable.ptr57 = load ptr, ptr %c53, align 8
  %method.ptr.addr58 = getelementptr ptr, ptr %vtable.ptr57, i64 11
  %method.ptr59 = load ptr, ptr %method.ptr.addr58, align 8
  %dispatch.result60 = call ptr %method.ptr59(ptr %c53)
  %dispatch.result61 = call i1 %method.ptr52(ptr %dispatch.result46, ptr %dispatch.result60)
  br i1 %dispatch.result61, label %then62, label %else71

dispatch.abort55:                                 ; preds = %dispatch.ok47
  call void @abort()
  unreachable

then62:                                           ; preds = %dispatch.ok54
  %self63 = load ptr, ptr %this.addr, align 8
  %dispatch.isnull66 = icmp eq ptr %self63, null
  br i1 %dispatch.isnull66, label %dispatch.abort65, label %dispatch.ok64

dispatch.ok64:                                    ; preds = %then62
  %vtable.ptr67 = load ptr, ptr %self63, align 8
  %method.ptr.addr68 = getelementptr ptr, ptr %vtable.ptr67, i64 5
  %method.ptr69 = load ptr, ptr %method.ptr.addr68, align 8
  %dispatch.result70 = call ptr %method.ptr69(ptr %self63, ptr @.str.18088364639186711304)
  br label %ifcont80

dispatch.abort65:                                 ; preds = %then62
  call void @abort()
  unreachable

else71:                                           ; preds = %dispatch.ok54
...
dispatch.ok73:                                    ; preds = %else71
  ...
  %dispatch.result79 = call ptr %method.ptr78(ptr %self72, ptr @.str.15701132810540416685)
  br label %ifcont80

dispatch.abort74:                                 ; preds = %else71
  call void @abort()
  unreachable

ifcont80:                                         ; preds = %dispatch.ok73, %dispatch.ok64
  %cond_result81 = phi ptr [ %dispatch.result70, %dispatch.ok64 ], [ %dispatch.result79, %dispatch.ok73 ]
  ret ptr %cond_result81
}
...
define i1 @Complex.equal(ptr %this, ptr %d) {
entry:
  %this.addr = alloca ptr, align 8
  store ptr %this, ptr %this.addr, align 8
  ...
  %x.addr = getelementptr i8, ptr %self, i32 8
  %x = load i32, ptr %x.addr, align 4
  %d1 = load ptr, ptr %d.addr, align 8
  %dispatch.isnull = icmp eq ptr %d1, null
  br i1 %dispatch.isnull, label %dispatch.abort, label %dispatch.ok

dispatch.ok:                                      ; preds = %entry
  %vtable.ptr = load ptr, ptr %d1, align 8
  %method.ptr.addr = getelementptr ptr, ptr %vtable.ptr, i64 15
  %method.ptr = load ptr, ptr %method.ptr.addr, align 8
  %dispatch.result = call i32 %method.ptr(ptr %d1)
  %eqtmp = icmp eq i32 %x, %dispatch.result
...
then:                                             ; preds = %dispatch.ok
  ...
  %y.addr = getelementptr i8, ptr %self2, i32 16
  %y = load i32, ptr %y.addr, align 4
  %d3 = load ptr, ptr %d.addr, align 8
  %dispatch.isnull6 = icmp eq ptr %d3, null
  br i1 %dispatch.isnull6, label %dispatch.abort5, label %dispatch.ok4

dispatch.ok4:                                     ; preds = %then
  %vtable.ptr7 = load ptr, ptr %d3, align 8
  %method.ptr.addr8 = getelementptr ptr, ptr %vtable.ptr7, i64 16
  %method.ptr9 = load ptr, ptr %method.ptr.addr8, align 8
  %dispatch.result10 = call i32 %method.ptr9(ptr %d3)
  %eqtmp11 = icmp eq i32 %y, %dispatch.result10
  br i1 %eqtmp11, label %then12, label %else

dispatch.abort5:                                  ; preds = %then
  call void @abort()
  unreachable

then12:                                           ; preds = %dispatch.ok4
  br label %ifcont

else:                                             ; preds = %dispatch.ok4
  br label %ifcont

ifcont:                                           ; preds = %else, %then12
  %cond_result = phi i1 [ true, %then12 ], [ false, %else ]
  br label %ifcont14

else13:                                           ; preds = %dispatch.ok
  br label %ifcont14

ifcont14:                                         ; preds = %else13, %ifcont
  %cond_result15 = phi i1 [ %cond_result, %ifcont ], [ false, %else13 ]
  ret i1 %cond_result15
}

define i32 @Complex.x_value(ptr %this) {
entry:
  %this.addr = alloca ptr, align 8
  store ptr %this, ptr %this.addr, align 8
  %self = load ptr, ptr %this.addr, align 8
...
define i32 @Complex.y_value(ptr %this) {
entry:
  %this.addr = alloca ptr, align 8
  store ptr %this, ptr %this.addr, align 8
  %self = load ptr, ptr %this.addr, align 8
