...
@.str.597299828920672303 = private constant [4 x i8] c"-17\00"
@.str.18400681194753865968 = private constant [2 x i8] c"\0A\00"
@.str.3761182000229409695 = private constant [5 x i8] c"2048\00"
...
dispatch.ok2:                                     ; preds = %dispatch.ok
  ...
  %dispatch.result = call i32 %method.ptr7(ptr %z1, ptr @.str.597299828920672303)
...
dispatch.ok25:                                    ; preds = %dispatch.ok18
  ...
  %dispatch.result31 = call ptr %method.ptr30(ptr %z24, i32 -17)
...
dispatch.ok42:                                    ; preds = %dispatch.ok34
  ...
  %method.ptr.addr46 = getelementptr ptr, ptr %vtable.ptr45, i64 6
...
dispatch.ok49:                                    ; preds = %dispatch.ok42
  ...
  %method.ptr.addr53 = getelementptr ptr, ptr %vtable.ptr52, i64 7
  %method.ptr54 = load ptr, ptr %method.ptr.addr53, align 8
  %dispatch.result55 = call i32 %method.ptr54(ptr %z48, ptr @.str.3761182000229409695)
  %dispatch.result56 = call ptr %method.ptr47(ptr %self41, i32 %dispatch.result55)
...
dispatch.ok58:                                    ; preds = %dispatch.ok49
  ...
  %dispatch.result64 = call ptr %method.ptr63(ptr %self57, ptr @.str.18400681194753865968)
...
dispatch.abort59:                                 ; preds = %dispatch.ok49
  call void @abort()
  unreachable
...
dispatch.ok66:                                    ; preds = %dispatch.ok58
  ...
  %z72 = load ptr, ptr %z, align 8
  %dispatch.isnull75 = icmp eq ptr %z72, null
...
dispatch.ok73:                                    ; preds = %dispatch.ok66
  %vtable.ptr76 = load ptr, ptr %z72, align 8
  %method.ptr.addr77 = getelementptr ptr, ptr %vtable.ptr76, i64 9
  %method.ptr78 = load ptr, ptr %method.ptr.addr77, align 8
  %dispatch.result79 = call ptr %method.ptr78(ptr %z72, i32 2048)
  %dispatch.result80 = call ptr %method.ptr71(ptr %self65, ptr %dispatch.result79)
...
dispatch.abort74:                                 ; preds = %dispatch.ok66
  call void @abort()
  unreachable

dispatch.ok82:                                    ; preds = %dispatch.ok73
  ...
  %dispatch.result88 = call ptr %method.ptr87(ptr %self81, ptr @.str.18400681194753865968)
  ret ptr %dispatch.result88

dispatch.abort83:                                 ; preds = %dispatch.ok73
  call void @abort()
  unreachable
}
